...
config :chatroom, ChatroomWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "9Nrzfa0ufEVAQkbx6Ttqd6GM+IIfMWxQJQ0kV4cAwAWWqqzRrg/a9u8nZdTJfS3I",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:chatroom, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:chatroom, ~w(--watch)]}
  ]
...
config :chatroom, dev_routes: true
